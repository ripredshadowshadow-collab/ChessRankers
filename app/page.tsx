  ...
  return <div className="cr-shell">
    <nav className="cr-nav">
      ...
      <div className="cr-links">
        <a href="/play">Play AI</a><a href="/solo">Solo Chess</a><a href="/tester">Move Tester</a><a href="/leaderboard">Leaderboard</a><a href="/profile">Profile</a>
      </div>
    </nav>
    ...
    <main className="cr-main">
      <section className="cr-hero">
        <div>
          ...
          <div className="cr-actions"><a className="cr-btn primary" href="/play">Play Rated AI</a><a className="cr-btn" href="/solo">Try Solo Chess</a></div>
      ...
      <section className="cr-section"><h2>One arena, separate ranks</h2><p>Rated AI games and Solo Chess have independent global leaderboards. PvP is not part of ChessRankers.</p>
        <div className="cr-feature-grid">
          ...
          <div className="cr-card cr-feature"><strong>Move Tester</strong><span>Experiment with positions, variations and moves without affecting your rating.</span></div>
          <div className="cr-card cr-feature"><strong>Infinite Board</strong><span>Build arbitrary positions, choose the side to move and test them against AI.</span></div>
        </div>
      </section>
    </main>
  </div>;
